...
T = {
    ...
    # ─── 2026-05-06 lupdate refresh: sync-repair yellow-state + sync status badge ───
    "Some videos could not be reliably synchronized. Try to repair them automatically?": {
        "cs": "Některá videa se nepodařilo spolehlivě synchronizovat. Pokusit se o automatickou opravu?",
        "da": "Nogle videoer kunne ikke synkroniseres pålideligt. Prøv at reparere dem automatisk?",
        "de": "Einige Videos konnten nicht zuverlässig synchronisiert werden. Automatische Reparatur versuchen?",
        "el": "Ορισμένα βίντεο δεν συγχρονίστηκαν αξιόπιστα. Να γίνει αυτόματη επιδιόρθωση;",
        "es": "Algunos vídeos no se pudieron sincronizar de forma fiable. ¿Intentar repararlos automáticamente?",
        "fi": "Joitain videoita ei voitu synkronoida luotettavasti. Yritetäänkö korjata ne automaattisesti?",
        "fr": "Certaines vidéos n'ont pas pu être synchronisées de manière fiable. Essayer de les réparer automatiquement ?",
        "gl": "Algúns vídeos non se puideron sincronizar de xeito fiable. Tentar repáralos automaticamente?",
        "id": "Beberapa video tidak dapat disinkronkan dengan andal. Coba perbaiki secara otomatis?",
        "it": "Alcuni video non sono stati sincronizzati in modo affidabile. Provare a ripararli automaticamente?",
        "ja": "一部の動画を確実に同期できませんでした。自動修復を試みますか？",
        "ko": "일부 동영상을 안정적으로 동기화하지 못했습니다. 자동으로 복구를 시도하시겠습니까?",
        "no": "Noen videoer kunne ikke synkroniseres pålitelig. Prøv å reparere dem automatisk?",
        "pl": "Niektóre filmy nie zostały niezawodnie zsynchronizowane. Spróbować je naprawić automatycznie?",
        "pt": "Alguns vídeos não foram sincronizados de forma fiável. Tentar repará-los automaticamente?",
        "pt_BR": "Alguns vídeos não foram sincronizados de forma confiável. Tentar repará-los automaticamente?",
        "ru": "Некоторые видео не удалось надёжно синхронизировать. Попытаться исправить их автоматически?",
        "sk": "Niektoré videá sa nepodarilo spoľahlivo synchronizovať. Pokúsiť sa o automatickú opravu?",
        "tr": "Bazı videolar güvenilir biçimde senkronize edilemedi. Otomatik olarak onarılsın mı?",
        "uk": "Деякі відео не вдалося надійно синхронізувати. Спробувати виправити їх автоматично?",
        "zh_CN": "部分视频未能可靠同步。是否尝试自动修复？",
        "zh_TW": "部分影片無法可靠同步。要嘗試自動修復嗎?",
    },
    "Repair": {
        "cs": "Opravit", "da": "Reparér", "de": "Reparieren", "el": "Επιδιόρθωση",
        "es": "Reparar", "fi": "Korjaa", "fr": "Réparer", "gl": "Reparar",
        "id": "Perbaiki", "it": "Ripara", "ja": "修復", "ko": "복구",
        "no": "Reparér", "pl": "Napraw", "pt": "Reparar", "pt_BR": "Reparar",
        "ru": "Исправить", "sk": "Opraviť", "tr": "Onar", "uk": "Виправити",
        "zh_CN": "修复", "zh_TW": "修復",
    },
    "Skip": {
        "cs": "Přeskočit", "da": "Spring over", "de": "Überspringen", "el": "Παράλειψη",
        "es": "Omitir", "fi": "Ohita", "fr": "Ignorer", "gl": "Omitir",
        "id": "Lewati", "it": "Salta", "ja": "スキップ", "ko": "건너뛰기",
        "no": "Hopp over", "pl": "Pomiń", "pt": "Ignorar", "pt_BR": "Ignorar",
        "ru": "Пропустить", "sk": "Preskočiť", "tr": "Atla", "uk": "Пропустити",
        "zh_CN": "跳过", "zh_TW": "跳過",
    },
    "Some videos are still not reliably synchronized after repair.": {
        "cs": "Některá videa stále nejsou spolehlivě synchronizována ani po opravě.",
        "da": "Nogle videoer er stadig ikke synkroniseret pålideligt efter reparation.",
        "de": "Einige Videos sind auch nach der Reparatur nicht zuverlässig synchronisiert.",
        "el": "Ορισμένα βίντεο εξακολουθούν να μην συγχρονίζονται αξιόπιστα μετά την επιδιόρθωση.",
        "es": "Algunos vídeos siguen sin estar sincronizados de forma fiable tras la reparación.",
        "fi": "Joitain videoita ei vieläkään ole synkronoitu luotettavasti korjauksen jälkeen.",
        "fr": "Certaines vidéos ne sont toujours pas synchronisées de manière fiable après réparation.",
        "gl": "Algúns vídeos seguen sen sincronizarse de xeito fiable tras a reparación.",
        "id": "Beberapa video masih belum tersinkron dengan andal setelah perbaikan.",
        "it": "Alcuni video non sono ancora sincronizzati in modo affidabile dopo la riparazione.",
        "ja": "修復後も一部の動画が確実に同期されていません。",
        "ko": "복구 후에도 일부 동영상이 안정적으로 동기화되지 않았습니다.",
        "no": "Noen videoer er fortsatt ikke synkronisert pålitelig etter reparasjon.",
        "pl": "Niektóre filmy nadal nie są niezawodnie zsynchronizowane po naprawie.",
        "pt": "Alguns vídeos continuam sem sincronização fiável após a reparação.",
        "pt_BR": "Alguns vídeos continuam sem sincronização confiável após o reparo.",
        "ru": "Некоторые видео всё ещё не синхронизированы надёжно после исправления.",
        "sk": "Niektoré videá stále nie sú spoľahlivo synchronizované ani po oprave.",
        "tr": "Bazı videolar onarımdan sonra hâlâ güvenilir biçimde senkronize değil.",
        "uk": "Деякі відео все ще не синхронізовано надійно після виправлення.",
        "zh_CN": "修复后仍有部分视频未能可靠同步。",
        "zh_TW": "修復後仍有部分影片無法可靠同步。",
    },
    "Batch synchronization did not produce a reliable result. Check gyro splitting or batch matching and try again.": {
        "cs": "Hromadná synchronizace nepřinesla spolehlivý výsledek. Zkontrolujte rozdělení gyro souborů nebo hromadné párování a zkuste znovu.",
        "da": "Batch-synkronisering gav ikke et pålideligt resultat. Tjek gyro-opdeling eller batch-matchning og prøv igen.",
        "de": "Die Stapelsynchronisation lieferte kein zuverlässiges Ergebnis. Prüfe die Gyro-Aufteilung oder die Stapel-Zuordnung und versuche es erneut.",
        "el": "Ο μαζικός συγχρονισμός δεν παρήγαγε αξιόπιστο αποτέλεσμα. Ελέγξτε τη διάσπαση γυροσκοπίου ή τη μαζική αντιστοίχιση και προσπαθήστε ξανά.",
        "es": "La sincronización por lotes no produjo un resultado fiable. Revisa la división del giroscopio o la coincidencia por lotes e inténtalo de nuevo.",
        "fi": "Eräsynkronointi ei tuottanut luotettavaa tulosta. Tarkista gyron jako tai erävastaavuus ja yritä uudelleen.",
        "fr": "La synchronisation par lots n'a pas produit de résultat fiable. Vérifiez le partage gyro ou l'appariement par lots, puis réessayez.",
        "gl": "A sincronización en lote non produciu un resultado fiable. Comproba a división xiroscópica ou a correspondencia en lote e téntao de novo.",
        "id": "Sinkronisasi batch tidak menghasilkan hasil yang andal. Periksa pembagian giro atau pencocokan batch lalu coba lagi.",
        "it": "La sincronizzazione in batch non ha prodotto un risultato affidabile. Controlla la suddivisione del giroscopio o l'abbinamento in batch e riprova.",
        "ja": "一括同期で信頼できる結果が得られませんでした。ジャイロ分割または一括マッチングを確認して再試行してください。",
        "ko": "일괄 동기화에서 안정적인 결과를 얻지 못했습니다. 자이로 분할 또는 일괄 매칭을 확인 후 다시 시도하세요.",
        "no": "Batch-synkronisering ga ikke et pålitelig resultat. Sjekk gyro-deling eller batch-matching og prøv igjen.",
        "pl": "Synchronizacja wsadowa nie dała wiarygodnego wyniku. Sprawdź podział gyro lub dopasowanie wsadowe i spróbuj ponownie.",
        "pt": "A sincronização em lote não produziu um resultado fiável. Verifique a divisão do giroscópio ou a correspondência em lote e tente novamente.",
        "pt_BR": "A sincronização em lote não produziu um resultado confiável. Verifique a divisão do giroscópio ou a correspondência em lote e tente novamente.",
        "ru": "Пакетная синхронизация не дала надёжного результата. Проверьте разделение гиро или пакетное сопоставление и повторите попытку.",
        "sk": "Hromadná synchronizácia nepriniesla spoľahlivý výsledok. Skontrolujte rozdelenie gyra alebo hromadné priraďovanie a skúste znova.",
        "tr": "Toplu senkronizasyon güvenilir sonuç vermedi. Gyro bölünmesini veya toplu eşleştirmeyi kontrol edip tekrar deneyin.",
        "uk": "Пакетна синхронізація не дала надійного результату. Перевірте поділ гіро або пакетне зіставлення та повторіть спробу.",
        "zh_CN": "批量同步未产出可靠结果。请检查陀螺仪分组或批量匹配后重试。",
        "zh_TW": "批次同步未產出可靠結果。請檢查陀螺儀分組或批次比對後重試。",
    },
    "Sync confirmed": {
        "cs": "Synchronizace potvrzena", "da": "Synkronisering bekræftet",
        "de": "Synchronisation bestätigt", "el": "Ο συγχρονισμός επιβεβαιώθηκε",
        "es": "Sincronización confirmada", "fi": "Synkronointi vahvistettu",
        "fr": "Synchronisation confirmée", "gl": "Sincronización confirmada",
        "id": "Sinkronisasi dikonfirmasi", "it": "Sincronizzazione confermata",
        "ja": "同期確認済み", "ko": "동기화 확인됨",
        "no": "Synkronisering bekreftet", "pl": "Synchronizacja potwierdzona",
        "pt": "Sincronização confirmada", "pt_BR": "Sincronização confirmada",
        "ru": "Синхронизация подтверждена", "sk": "Synchronizácia potvrdená",
        "tr": "Senkronizasyon onaylandı", "uk": "Синхронізацію підтверджено",
        "zh_CN": "同步已确认", "zh_TW": "同步已確認",
    },
    "Sync not confirmed": {
        "cs": "Synchronizace nepotvrzena", "da": "Synkronisering ikke bekræftet",
        "de": "Synchronisation nicht bestätigt", "el": "Ο συγχρονισμός δεν επιβεβαιώθηκε",
        "es": "Sincronización no confirmada", "fi": "Synkronointia ei vahvistettu",
        "fr": "Synchronisation non confirmée", "gl": "Sincronización non confirmada",
        "id": "Sinkronisasi belum dikonfirmasi", "it": "Sincronizzazione non confermata",
        "ja": "同期未確認", "ko": "동기화 미확인",
        "no": "Synkronisering ikke bekreftet", "pl": "Synchronizacja niepotwierdzona",
        "pt": "Sincronização não confirmada", "pt_BR": "Sincronização não confirmada",
        "ru": "Синхронизация не подтверждена", "sk": "Synchronizácia nepotvrdená",
        "tr": "Senkronizasyon onaylanmadı", "uk": "Синхронізацію не підтверджено",
        "zh_CN": "同步未确认", "zh_TW": "同步未確認",
    },
}
