...
T = {
    ...
    "After the DMG opens, drag Gyroflow.app to the Applications folder.": {
        "cs": "Po otevření DMG přetáhněte Gyroflow.app do složky Applications.",
        "da": "Når DMG-filen åbnes, skal du trække Gyroflow.app til mappen Applications.",
        "de": "Ziehen Sie nach dem Öffnen der DMG-Datei Gyroflow.app in den Ordner Applications.",
        "el": "Όταν ανοίξει το DMG, σύρετε το Gyroflow.app στον φάκελο Applications.",
        "es": "Cuando se abra el DMG, arrastra Gyroflow.app a la carpeta Applications.",
        "fi": "Kun DMG avautuu, vedä Gyroflow.app Applications-kansioon.",
        "fr": "Une fois le DMG ouvert, faites glisser Gyroflow.app dans le dossier Applications.",
        "gl": "Unha vez aberto o DMG, arrastra Gyroflow.app ao cartafol Applications.",
        "id": "Setelah DMG terbuka, seret Gyroflow.app ke folder Applications.",
        "it": "Una volta aperto il DMG, trascina Gyroflow.app nella cartella Applications.",
        "ja": "DMG が開いたら、Gyroflow.app を Applications フォルダにドラッグしてください。",
        "ko": "DMG가 열리면 Gyroflow.app을 Applications 폴더로 드래그하세요.",
        "no": "Når DMG-filen åpnes, drar du Gyroflow.app til Applications-mappen.",
        "pl": "Po otwarciu DMG przeciągnij Gyroflow.app do folderu Applications.",
        "pt": "Depois de abrir o DMG, arraste Gyroflow.app para a pasta Applications.",
        "pt_BR": "Depois que o DMG abrir, arraste o Gyroflow.app para a pasta Applications.",
        "ru": "После открытия DMG перетащите Gyroflow.app в папку Applications.",
        "sk": "Po otvorení DMG pretiahnite Gyroflow.app do priečinka Applications.",
        "tr": "DMG açıldıktan sonra Gyroflow.app'i Applications klasörüne sürükleyin.",
        "uk": "Після відкриття DMG перетягніть Gyroflow.app до теки Applications.",
        "zh_CN": "打开 DMG 后，请将 Gyroflow.app 拖入 Applications 文件夹。",
        "zh_TW": "打開 DMG 後，請將 Gyroflow.app 拖入 Applications 資料夾。",
    },
    "Update is ready.": {
