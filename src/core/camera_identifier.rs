...
impl CameraIdentifier {
                    ...
                    for info in samples {
                        if let Some(ref tag_map) = info.tag_map {
                            if let Some(map) = tag_map.get(&GroupId::Default) {
                                if let Some(v) = map.get_t(TagId::Unknown(0x45495341 /*EISA*/))
                                    as Option<&String>
                                {
                                    if v != "N/A" {
                                ...
                                if let Some(v) = map.get_t(TagId::Unknown(0x45495345 /*EISE*/))
                                    as Option<&String>
                                {
                                ...
                                if let Some(v) = map.get_t(TagId::Unknown(0x56464f56 /*VFOV*/))
                                    as Option<&String>
                                {
                                    match v.as_str() {
                                ...
                                if let Some(v) =
                                    map.get_t(TagId::Unknown(0x5a464f56 /*ZFOV*/)) as Option<&f32>
                                {
                                    if id.lens_info == "Linear" && *v < 80.0 {
                                        id.lens_info = "Narrow".into();
                                    }
                                }
                                if let Some(v) = map.get_t(TagId::Unknown(0x50524a54 /*PRJT*/))
                                    as Option<&String>
                                {
                                    if v.as_str() == "GPMW" {
                ...
                if let Some(ref samples) = input.samples {
                    if let Some(info) = samples.iter().next() {
                        if let Some(ref tag_map) = info.tag_map {
                            ...
                            if let Some(v) = tag_map
                                .get(&GroupId::Custom("LensDistortion".into()))
                                .and_then(|map| {
                                    map.get_t(TagId::Data) as Option<&serde_json::Value>
                                })
                            {
                ...
                if let Some(ref samples) = input.samples {
                    for info in samples {
                        if let Some(ref tag_map) = info.tag_map {
                            if let Some(map) = tag_map.get(&GroupId::Default) {
                                if let Some(v) =
                                    map.get_t(TagId::Metadata) as Option<&serde_json::Value>
                                {
                                    if let Some(fov_type) =
                                        v.get("fov_type").and_then(|v| v.as_str())
                                    {
                                    ...
                                    if let Some(flowstate) =
                                        v.get("is_flowstate_online").and_then(|v| v.as_bool())
                                    {
                                        id.additional =
                                            if flowstate { "EIS" } else { "NO-EIS" }.into();
                                    }
                                }
                                break;
                            }
                        ...
                        if let Some(ref tag_map) = info.tag_map {
                            ...
                            if brand != "Runcam" {
                                if let Some(v) = tag_map.get(&GroupId::Lens).and_then(|map| {
                                    ...
                                    id.lens_model = v.clone();
                                } else if let Some(v) = tag_map
                                    .get(&GroupId::Lens)
                                    .and_then(|map| map.get_t(TagId::Name) as Option<&String>)
                                {
                                    id.lens_model = v.clone();
                                }
                            }
                            if let Some(map) = tag_map.get(&GroupId::Default) {
                                ...
                                {
                                    log::debug!(
                                        "Camera ID Brand: {}, Model: {}, Metadata: {:?}",
                                        id.brand,
                                        id.model,
                                        v
                                    );
    ...
    pub fn get_identifier_for_autoload(&self) -> String {
        self.identifier
            .replace("hero12", "hero11")
            .replace("hero13", "hero11")
            .replace("hero11blackmini", "hero11black")
    }

    fn get_identifier(&self) -> String {
        if self.brand.is_empty() || self.model.is_empty() || self.lens_info.is_empty() {
            return String::new();
        }
