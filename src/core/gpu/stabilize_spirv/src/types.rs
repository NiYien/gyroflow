...
pub fn rotate_point(pos: Vec2, angle: f32, origin: Vec2) -> Vec2 {
    vec2(
        angle.cos() * (pos.x - origin.x) - angle.sin() * (pos.y - origin.y) + origin.x,
...
mod inner_tex_type {
    ...
    pub fn to_float(v: UVec4) -> Vec4 {
        Vec4::new(v.x as f32, v.y as f32, v.z as f32, v.w as f32)
    }
    pub fn from_float(v: Vec4) -> UVec4 {
        UVec4::new(v.x as u32, v.y as u32, v.z as u32, v.w as u32)
    }
}
...
mod inner_tex_type {
    ...
    #[inline]
    pub fn to_float(v: Vec4) -> Vec4 {
        v
    }
    #[inline]
    pub fn from_float(v: Vec4) -> Vec4 {
        v
    }
}
