// Generated from ONNX "C:/Users/Jhe/Desktop/github/gyroflow-burn-neuflow/resources/neuflow_v2_clean.onnx" by burn-onnx
use burn::prelude::*;
...
impl<B: Backend> Submodule1<B> {
    ...
    pub fn forward(
        ...
        let div1_out1 = img0
            .div((constant91_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let div2_out1 = img1
        ...
        let concat4_out1 = burn::tensor::Tensor::cat(
            [leakyrelu12_out1, constant93_out1].into(),
            1,
        );
        ...
        let mul1_out1 = linear1_out1
            .mul((constant136_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul6_out1 = transpose3_out1
            .mul((constant136_out1).unsqueeze_dims(&[0isize, 1isize]));
        let matmul12_out1 = mul5_out1.matmul(mul6_out1);
        let softmax2_out1 = burn::tensor::activation::softmax(matmul12_out1, 2);
...
pub struct Submodule2<B: Backend> {
    ...
    constant103: burn::module::Param<Tensor<B, 3>>,
    constant105: burn::module::Param<Tensor<B, 4>>,
    constant108: burn::module::Param<Tensor<B, 1>>,
    constant110: burn::module::Param<Tensor<B, 4>>,
...
impl<B: Backend> Submodule2<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant103: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([1, 1200, 2], device),
            device.clone(),
            false,
            [1, 1200, 2].into(),
        );
        let constant105: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                4,
            >::zeros([1, 2, 30, 40], device),
            device.clone(),
            false,
            [1, 2, 30, 40].into(),
        );
        ...
        let constant110: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                4,
            >::zeros([1200, 9, 9, 2], device),
            device.clone(),
            false,
            [1200, 9, 9, 2].into(),
        );
    ...
    pub fn forward(
        ...
        let softmax3_out1 = burn::tensor::activation::softmax(matmul17_out1, 2);
        let constant103_out1 = self.constant103.val();
        let matmul18_out1 = softmax3_out1.matmul(constant103_out1);
        ...
        let sub1_out1 = transpose6_out1.sub(constant105_out1.clone());
        ...
        let div5_out1 = reshape8_out1
            .div((constant108_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let add5_out1 = constant105_out1.add(sub1_out1.clone());
        ...
        let add6_out1 = reshape9_out1.add(constant110_out1);
        ...
        let mul11_out1 = split3_out1
            .mul((constant111_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let resize1_out1 = self.resize1.forward(add7_out1);
        let mul13_out1 = resize1_out1
            .mul((constant111_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let resize2_out1 = self.resize2.forward(split1_out2);
        ...
        let add8_out1 = erf3_out1
            .add((constant98_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let mul14_out1 = conv2d21_out1.mul(add8_out1);
        let mul15_out1 = mul14_out1
            .mul((constant99_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let div9_out1 = reshape13_out1
            .div((constant108_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let resize3_out1 = self.resize3.forward(relu1_out1);
        ...
        let add9_out1 = erf4_out1
            .add((constant98_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let mul16_out1 = conv2d23_out1.mul(add9_out1);
        let mul17_out1 = mul16_out1
            .mul((constant99_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        (mul17_out1, mul13_out1, constant111_out1, div9_out1)
    }
}
#[derive(Module, Debug)]
pub struct Submodule3<B: Backend> {
    ...
    constant126: burn::module::Param<Tensor<B, 4>>,
...
impl<B: Backend> Submodule3<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant126: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                4,
            >::zeros([1, 64, 60, 80], device),
            device.clone(),
            false,
            [1, 64, 60, 80].into(),
        );
    ...
    pub fn forward(
        ...
        let add10_out1 = constant120_out1.clone().add(mul13_out1.clone());
        ...
        let add11_out1 = reshape14_out1.add(constant122_out1.clone());
        ...
        let div11_out1 = mul18_out1
            .div((constant123_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let div12_out1 = mul19_out1
            .div((constant124_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let sub5_out1 = div12_out1
            .sub((constant98_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let concat13_out1 = burn::tensor::Tensor::cat([sub4_out1, sub5_out1].into(), 3);
        let gridsample2_out1 = div9_out1
            .clone()
            .grid_sample_2d(
                concat13_out1,
                burn::tensor::ops::GridSampleOptions::new(
        ...
        let add13_out1 = constant120_out1.clone().add(add12_out1.clone());
        let transpose13_out1 = add13_out1.permute([0, 2, 3, 1]);
        let reshape16_out1 = transpose13_out1.reshape([4800, 1, 1, 2]);
        let add14_out1 = reshape16_out1.add(constant122_out1.clone());
        ...
        let mul21_out1 = split5_out2
            .mul((constant111_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let div14_out1 = mul21_out1
            .div((constant124_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let sub7_out1 = div14_out1
            .sub((constant98_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let concat15_out1 = burn::tensor::Tensor::cat([sub6_out1, sub7_out1].into(), 3);
        let gridsample3_out1 = div9_out1
            .grid_sample_2d(
                concat15_out1,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
...
impl<B: Backend> Submodule4<B> {
    ...
    pub fn forward(
        ...
        constant120_out1: Tensor<B, 4>,
        constant122_out1: Tensor<B, 4>,
        constant111_out1: Tensor<B, 1>,
        constant123_out1: Tensor<B, 1>,
        constant98_out1: Tensor<B, 1>,
        constant124_out1: Tensor<B, 1>,
        div9_out1: Tensor<B, 4>,
        conv2d24_out1: Tensor<B, 4>,
        constant127_out1: Tensor<B, 4>,
        ...
        let add16_out1 = constant120_out1.clone().add(add15_out1.clone());
        let transpose15_out1 = add16_out1.permute([0, 2, 3, 1]);
        let reshape18_out1 = transpose15_out1.reshape([4800, 1, 1, 2]);
        let add17_out1 = reshape18_out1.add(constant122_out1.clone());
        ...
        let gridsample4_out1 = div9_out1
            .clone()
            .grid_sample_2d(
                concat17_out1,
                burn::tensor::ops::GridSampleOptions::new(
        ...
        let add19_out1 = constant120_out1.add(add18_out1.clone());
        let transpose17_out1 = add19_out1.permute([0, 2, 3, 1]);
        let reshape20_out1 = transpose17_out1.reshape([4800, 1, 1, 2]);
        let add20_out1 = reshape20_out1.add(constant122_out1);
        ...
        let div17_out1 = mul24_out1
            .div((constant123_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let sub10_out1 = div17_out1
            .sub((constant98_out1.clone()).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let mul25_out1 = split7_out2
            .mul((constant111_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let div18_out1 = mul25_out1
            .div((constant124_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let gridsample5_out1 = div9_out1
            .grid_sample_2d(
                concat19_out1,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
...
impl<B: Backend> Submodule5<B> {
    ...
    pub fn forward(
        ...
        let add22_out1 = constant120_out1.clone().add(add21_out1.clone());
        let transpose19_out1 = add22_out1.permute([0, 2, 3, 1]);
        let reshape22_out1 = transpose19_out1.reshape([4800, 1, 1, 2]);
        let add23_out1 = reshape22_out1.add(constant122_out1.clone());
        ...
        let gridsample6_out1 = div9_out1
            .clone()
            .grid_sample_2d(
                concat21_out1,
                burn::tensor::ops::GridSampleOptions::new(
        ...
        let add25_out1 = constant120_out1.add(add24_out1.clone());
        let transpose21_out1 = add25_out1.permute([0, 2, 3, 1]);
        let reshape24_out1 = transpose21_out1.reshape([4800, 1, 1, 2]);
        let add26_out1 = reshape24_out1.add(constant122_out1);
        ...
        let gridsample7_out1 = div9_out1
            .grid_sample_2d(
                concat23_out1,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
...
impl<B: Backend> Submodule6<B> {
    ...
    pub fn forward(
        ...
        let add28_out1 = constant120_out1.clone().add(add27_out1.clone());
        let transpose23_out1 = add28_out1.permute([0, 2, 3, 1]);
        let reshape26_out1 = transpose23_out1.reshape([4800, 1, 1, 2]);
        let add29_out1 = reshape26_out1.add(constant122_out1.clone());
        ...
        let gridsample8_out1 = div9_out1
            .clone()
            .grid_sample_2d(
                concat25_out1,
                burn::tensor::ops::GridSampleOptions::new(
        ...
        let add31_out1 = constant120_out1.add(add30_out1.clone());
        let transpose25_out1 = add31_out1.permute([0, 2, 3, 1]);
        let reshape28_out1 = transpose25_out1.reshape([4800, 1, 1, 2]);
        let add32_out1 = reshape28_out1.add(constant122_out1);
        ...
        let gridsample9_out1 = div9_out1
            .grid_sample_2d(
                concat27_out1,
                burn::tensor::ops::GridSampleOptions::new(
                        burn::tensor::ops::InterpolateMode::Bilinear,
        ...
        let softmax4_out1 = burn::tensor::activation::softmax(reshape30_out1, 2);
        ...
        let reducesum1_out1 = {
            mul34_out1.sum_dim(2usize).squeeze_dims::<6usize>(&[2])
        };
        ...
        let mul35_out1 = reshape32_out1
            .mul((constant134_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        mul35_out1
    }
}
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "C:/Users/Jhe/Desktop/github/gyroflow-burn-neuflow/src/core/neuflow_burn\\neuflow_v2_clean.bpk",
            &Default::default(),
        )
    }
}
...
impl<B: Backend> Model<B> {
    ...
    pub fn forward(&self, img0: Tensor<B, 4>, img1: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let (mul17_out1, mul13_out1, constant111_out1, div9_out1) = self
            .submodule2
            .forward(
                add4_out1,
                leakyrelu6_out1,
        ...
        let (concat20_out1, add18_out1) = self
            ...
            .forward(
                leakyrelu29_out1,
                add12_out1,
                constant120_out1.clone(),
                constant122_out1.clone(),
                constant111_out1.clone(),
                constant123_out1.clone(),
                constant98_out1.clone(),
                constant124_out1.clone(),
                div9_out1.clone(),
                conv2d24_out1.clone(),
                constant127_out1.clone(),
            );
