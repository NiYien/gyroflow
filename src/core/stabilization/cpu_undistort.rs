...
pub const COEFFS: [f32; 64 + 128 + 256 + 9 * 4 + 4] = [
    // Bilinear
    // offset 0
    1.000000, 0.000000, 0.968750, 0.031250, 0.937500, 0.062500, 0.906250, 0.093750, 0.875000,
    0.125000, 0.843750, 0.156250, 0.812500, 0.187500, 0.781250, 0.218750, 0.750000, 0.250000,
    0.718750, 0.281250, 0.687500, 0.312500, 0.656250, 0.343750, 0.625000, 0.375000, 0.593750,
    0.406250, 0.562500, 0.437500, 0.531250, 0.468750, 0.500000, 0.500000, 0.468750, 0.531250,
    0.437500, 0.562500, 0.406250, 0.593750, 0.375000, 0.625000, 0.343750, 0.656250, 0.312500,
    0.687500, 0.281250, 0.718750, 0.250000, 0.750000, 0.218750, 0.781250, 0.187500, 0.812500,
    0.156250, 0.843750, 0.125000, 0.875000, 0.093750, 0.906250, 0.062500, 0.937500, 0.031250,
    0.968750, // Bicubic
    // offset 64
    0.000000, 1.000000, 0.000000, 0.000000, -0.021996, 0.997841, 0.024864, -0.000710, -0.041199,
    0.991516, 0.052429, -0.002747, -0.057747, 0.981255, 0.082466, -0.005974, -0.071777, 0.967285,
    0.114746, -0.010254, -0.083427, 0.949837, 0.149040, -0.015450, -0.092834, 0.929138, 0.185120,
    -0.021423, -0.100136, 0.905418, 0.222755, -0.028038, -0.105469, 0.878906, 0.261719, -0.035156,
    -0.108971, 0.849831, 0.301781, -0.042641, -0.110779, 0.818420, 0.342712, -0.050354, -0.111031,
    0.784904, 0.384285, -0.058159, -0.109863, 0.749512, 0.426270, -0.065918, -0.107414, 0.712471,
    0.468437, -0.073494, -0.103821, 0.674011, 0.510559, -0.080750, -0.099220, 0.634361, 0.552406,
    -0.087547, -0.093750, 0.593750, 0.593750, -0.093750, -0.087547, 0.552406, 0.634361, -0.099220,
    -0.080750, 0.510559, 0.674011, -0.103821, -0.073494, 0.468437, 0.712471, -0.107414, -0.065918,
    0.426270, 0.749512, -0.109863, -0.058159, 0.384285, 0.784904, -0.111031, -0.050354, 0.342712,
    0.818420, -0.110779, -0.042641, 0.301781, 0.849831, -0.108971, -0.035156, 0.261719, 0.878906,
    -0.105469, -0.028038, 0.222755, 0.905418, -0.100136, -0.021423, 0.185120, 0.929138, -0.092834,
    -0.015450, 0.149040, 0.949837, -0.083427, -0.010254, 0.114746, 0.967285, -0.071777, -0.005974,
    0.082466, 0.981255, -0.057747, -0.002747, 0.052429, 0.991516, -0.041199, -0.000710, 0.024864,
    0.997841, -0.021996, // Lanczos4
    // offset 192
    0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, -0.002981,
    0.009625, -0.027053, 0.998265, 0.029187, -0.010246, 0.003264, -0.000062, -0.005661, 0.018562,
    -0.051889, 0.993077, 0.060407, -0.021035, 0.006789, -0.000250, -0.008027, 0.026758, -0.074449,
    0.984478, 0.093543, -0.032281, 0.010545, -0.000567, -0.010071, 0.034167, -0.094690, 0.972534,
    0.128459, -0.043886, 0.014499, -0.001012, -0.011792, 0.040757, -0.112589, 0.957333, 0.165004,
    -0.055744, 0.018613, -0.001582, -0.013191, 0.046507, -0.128145, 0.938985, 0.203012, -0.067742,
    0.022845, -0.002271, -0.014275, 0.051405, -0.141372, 0.917621, 0.242303, -0.079757, 0.027146,
    -0.003071, -0.015054, 0.055449, -0.152304, 0.893389, 0.282684, -0.091661, 0.031468, -0.003971,
    -0.015544, 0.058648, -0.160990, 0.866453, 0.323952, -0.103318, 0.035754, -0.004956, -0.015761,
    0.061020, -0.167496, 0.836995, 0.365895, -0.114591, 0.039949, -0.006011, -0.015727, 0.062590,
    -0.171900, 0.805208, 0.408290, -0.125335, 0.043992, -0.007117, -0.015463, 0.063390, -0.174295,
    0.771299, 0.450908, -0.135406, 0.047823, -0.008254, -0.014995, 0.063460, -0.174786, 0.735484,
    0.493515, -0.144657, 0.051378, -0.009399, -0.014349, 0.062844, -0.173485, 0.697987, 0.535873,
    -0.152938, 0.054595, -0.010527, -0.013551, 0.061594, -0.170517, 0.659039, 0.577742, -0.160105,
    0.057411, -0.011613, -0.012630, 0.059764, -0.166011, 0.618877, 0.618877, -0.166011, 0.059764,
    -0.012630, -0.011613, 0.057411, -0.160105, 0.577742, 0.659039, -0.170517, 0.061594, -0.013551,
    -0.010527, 0.054595, -0.152938, 0.535873, 0.697987, -0.173485, 0.062844, -0.014349, -0.009399,
    0.051378, -0.144657, 0.493515, 0.735484, -0.174786, 0.063460, -0.014995, -0.008254, 0.047823,
    -0.135406, 0.450908, 0.771299, -0.174295, 0.063390, -0.015463, -0.007117, 0.043992, -0.125336,
    0.408290, 0.805208, -0.171900, 0.062590, -0.015727, -0.006011, 0.039949, -0.114591, 0.365895,
    0.836995, -0.167496, 0.061020, -0.015761, -0.004956, 0.035754, -0.103318, 0.323952, 0.866453,
    -0.160990, 0.058648, -0.015544, -0.003971, 0.031468, -0.091661, 0.282684, 0.893389, -0.152304,
    0.055449, -0.015054, -0.003071, 0.027146, -0.079757, 0.242303, 0.917621, -0.141372, 0.051405,
    -0.014275, -0.002271, 0.022845, -0.067742, 0.203012, 0.938985, -0.128145, 0.046507, -0.013191,
    -0.001582, 0.018613, -0.055744, 0.165004, 0.957333, -0.112589, 0.040757, -0.011792, -0.001012,
    0.014499, -0.043886, 0.128459, 0.972534, -0.094690, 0.034167, -0.010071, -0.000567, 0.010545,
    -0.032281, 0.093543, 0.984478, -0.074449, 0.026758, -0.008027, -0.000250, 0.006789, -0.021035,
    0.060407, 0.993077, -0.051889, 0.018562, -0.005661, -0.000062, 0.003264, -0.010246, 0.029187,
    0.998265, -0.027053, 0.009625, -0.002981, // Colors
    // offset 448
...
impl Stabilization {
    pub fn undistort_image_cpu_spirv<T: PixelType>(
        ...
        if let BufferSource::Cpu { buffer: input } = &mut buffers.input.data {
            if let BufferSource::Cpu { buffer: output } = &mut buffers.output.data {
                ...
                output
                    .par_chunks_mut(buffers.output.size.2)
                    .enumerate()
                    .for_each(|(y, row_bytes)| {
                        // Parallel iterator over buffer rows
                        row_bytes
                            .chunks_mut(params.bytes_per_pixel as usize)
                            .enumerate()
                            .for_each(|(x, pix_chunk)| {
                                // iterator over row pixels
                                let matrices2: &[f32] = unsafe {
                                    std::slice::from_raw_parts(
                                        matrices.as_ptr() as *const f32,
                                        matrices.len() * 14,
                                    )
                                };
                                let params2: stabilize_spirv::KernelParams =
                                    unsafe { std::mem::transmute(*params) };
                                let drawing2: &[u32] = unsafe {
                                    std::slice::from_raw_parts(
                                        drawing.as_ptr() as *const u32,
                                        drawing.len() / 4,
                                    )
                                };
        ...
        if _w > 0.0 {
                ...
                && params.light_refraction_coefficient > 0.0
            {
                if _w != 0.0 {
                    ...
                    let sin_theta_d =
                        (r / (1.0 + r * r).sqrt()) * params.light_refraction_coefficient;
                ...
                || matrices[13] != 0.0
            {
                ...
                let shifted = (
                    uv.0 - matrices[9] + matrices[12],
                    uv.1 - matrices[10] + matrices[13],
                );
                uv = (
            ...
            if !mesh_data.is_empty() && mesh_data[0] > 10.0 {
                ...
                if (params.flags & 128) == 128 {
                    uv.1 = params.height as f32 - uv.1;
                ...
                uv.1 = map_coord(
                    ...
                    origin.1,
                    origin.1 + crop_size.1,
                );

                let q = (uv.0 as f64, uv.1 as f64);
                let mut new_pos = crate::gyro_source::interpolate_mesh(
                    q.0,
                    q.1,
                ...
                if mesh_data.len() > fwd + 9 && mesh_data[fwd] > 10.0 {
                    let skip_sq = crate::gyro_source::MESH_REFINE_SKIP_PX
                        * crate::gyro_source::MESH_REFINE_SKIP_PX;
                    for _ in 0..2 {
                        let f = crate::gyro_source::interpolate_mesh(
                            new_pos.x,
                            new_pos.y,
                            (mesh_size.0, mesh_size.1),
                            &mesh_data[fwd..],
            ...
            if !mesh_data.is_empty() && mesh_data[0] > 0.0 && mesh_data[mesh_data[0] as usize] > 0.0
            {
                ...
                let origin = (mesh_data[5] as f32, mesh_data[6] as f32);
                let crop_size = (mesh_data[7] as f32, mesh_data[8] as f32);
                let stblz_grid = if mesh_data[o + 2] > 0.0 {
                    mesh_data[o + 2]
                } else {
                    mesh_size.1 / 8.0
                }; // band height comes with the table
            ...
            if params.input_horizontal_stretch > 0.001 {
                uv.0 /= params.input_horizontal_stretch;
            }
            if params.input_vertical_stretch > 0.001 {
                uv.1 /= params.input_vertical_stretch;
            }
    ...
    pub fn undistort_image_cpu<const I: i32, T: PixelType>(
        buffers: &mut Buffers,
        params: &KernelParams,
        distortion_model: &DistortionModel,
        digital_lens: Option<&DistortionModel>,
        ...
        fn bc2(x: f32, params: &KernelParams) -> f32 {
            ...
            unsafe {
                let x2 = x * x;
                if x < 1.0 {
                    return params.ewa_coeffs_p.get_unchecked(0)
                        + params.ewa_coeffs_p.get_unchecked(1) * x
                        + params.ewa_coeffs_p.get_unchecked(2) * x2
                        + params.ewa_coeffs_p.get_unchecked(3) * x2 * x;
                } else if x < 2.0 {
                    return params.ewa_coeffs_q.get_unchecked(0)
                        + params.ewa_coeffs_q.get_unchecked(1) * x
                        + params.ewa_coeffs_q.get_unchecked(2) * x2
                        + params.ewa_coeffs_q.get_unchecked(3) * x2 * x;
                }
            }
            0.0
        }
            ...
            if I > 8 {
                ...
                for in_y in bounds.2..=bounds.3 {
                    ...
                    for in_x in bounds.0..=bounds.1 {
                        ...
                        let pixel = if in_y >= params.source_rect[1]
                            && in_y < params.source_rect[1] + params.source_rect[3]
                            && in_x >= params.source_rect[0]
                            && in_x < params.source_rect[0] + params.source_rect[2]
                        {
                            let px1: &T = bytemuck::from_bytes(
                                &input[src_index as usize + (params.bytes_per_pixel * in_x) as usize
                                    ..src_index as usize
                                        + (params.bytes_per_pixel * (in_x + 1)) as usize],
                            );
                ...
                let mut src_index = sy as isize * params.stride as isize
                    + sx as isize * params.bytes_per_pixel as isize;
                ...
                for yp in 0..I {
                        ...
                        && sy + yp < params.source_rect[1] + params.source_rect[3]
                    {
                        ...
                        for xp in 0..I {
                            ...
                            {
                                let px1: &T = bytemuck::from_bytes(
                                    &input[src_index as usize
                                        + (params.bytes_per_pixel * xp) as usize
                                        ..src_index as usize
                                            + (params.bytes_per_pixel * (xp + 1)) as usize],
                                );
                                let src_px = PixelType::to_float(*px1);
                                // draw_pixel(&mut src_px, sx + xp, sy + yp, true, params.width, params, drawing);
                                src_px
        ...
        fn undistort_coord(
            ...
            out_pos.x = map_coord(
                out_pos.x,
                params.output_rect[0] as f32,
                (params.output_rect[0] + params.output_rect[2]) as f32,
                0.0,
                params.output_width as f32,
            );
            out_pos.y = map_coord(
                out_pos.y,
                params.output_rect[1] as f32,
                (params.output_rect[1] + params.output_rect[3]) as f32,
                0.0,
                params.output_height as f32,
            );

            // openfx-output-adjust-flip: mirror toggles applied before every other transform
            // (including translation2d and the post-affine block below). Identity-bypass when
            // both flag bits are clear keeps the byte-equivalent guarantee.
            ...
            if params.post_zoom != 1.0
                || params.post_scale != [1.0, 1.0]
                || params.post_rotation != 0.0
                || params.post_offset[0] != 0.0
                || params.post_offset[1] != 0.0
            {
                let mapped = PostAffine {
                    rotation_deg: params.post_rotation,
                    zoom: params.post_zoom,
                    scale_xy: params.post_scale,
                    offset_norm: params.post_offset,
                }
                .inverse_map_point(
                    [out_pos.x, out_pos.y],
            ...
            if params.lens_correction_amount < 1.0 {
                ...
                if (params.flags & 2) == 2 {
                    ...
                    if let Some(digital) = digital_lens {
                        if let Some(pt) =
                            digital.undistort_point((new_out_pos.x, new_out_pos.y), params)
                        {
                            new_out_pos.x = pt.0;
                            new_out_pos.y = pt.1;
                        }
                ...
                if let Some(pt) =
                    distortion_model.undistort_point((new_out_pos.x, new_out_pos.y), params)
                {
                    new_out_pos.x = pt.0;
                    new_out_pos.y = pt.1;
                }
                ...
                out_pos = new_out_pos * (1.0 - params.lens_correction_amount)
                    + (out_pos * params.lens_correction_amount);
            }
            ///////////////////////////////////////////////////////////////////

            ///////////////////////////////////////////////////////////////////
            // Calculate source `y` for rolling shutter
            let mut sy = if (params.flags & 16) == 16 {
                // Horizontal RS
            ...
            let mut uv = Stabilization::rotate_and_distort(
                (out_pos.x, out_pos.y),
                idx,
                params,
                matrices,
            ...
            if params.background_mode == 1 {
                ...
                if rx > width3 {
                    uv.0 = width3 - (rx - width3);
                }
                if rx < 3.0 {
                    uv.0 = 3.0 + width_f - (width3 + rx);
                }
                if ry > height3 {
                    uv.1 = height3 - (ry - height3);
                }
                if ry < 3.0 {
                    uv.1 = 3.0 + height_f - (height3 + ry);
                }
            }
            if params.background_mode != 3 {
                uv = (
                    map_coord(
                        ...
                        0.0,
                        frame_size.0,
                        params.source_rect[0] as f32,
                        (params.source_rect[0] + params.source_rect[2]) as f32,
                    ),
                    map_coord(
                        uv.1,
                        0.0,
                        frame_size.1,
                        params.source_rect[1] as f32,
                        (params.source_rect[1] + params.source_rect[3]) as f32,
                    ),
                );
            }
                    ...
                    .for_each(|(y, row_bytes)| {
                        ...
                        row_bytes
                            ...
                            .for_each(|(x, pix_chunk)| {
                                ...
                                if out_pos.0 >= 0.0
                                    && out_pos.1 >= 0.0
                                    && (out_pos.0 as i32) < params.output_width
                                    && (out_pos.1 as i32) < params.output_height
                                {
                                    // let p = out_pos;
                                    let mut pixel = bg;
                                    ...
                                    if let Some(mut uv) = undistort_coord(
                                        position,
                                        params,
                                        matrices,
                                        distortion_model,
                                        ...
                                        if I > 8 {
                                            let eps = 0.01;
                                            let xyx = undistort_coord(
                                                position + Vector2::new(eps, 0.0),
                                                params,
                                                matrices,
                                                distortion_model,
                                                digital_lens,
                                            ...
                                            .unwrap_or_default()
                                                - uv;
                                            let xyy = undistort_coord(
                                                position + Vector2::new(0.0, eps),
                                                params,
                                                matrices,
                                                distortion_model,
                                                digital_lens,
                                        ...
                                        if params.background_mode == 3 {
                                            ...
                                            let feather = (params.background_margin_feather
                                                * heightf)
                                                .max(0.0001);
                                            let mut pt2 = uv;
                                            let mut alpha = 1.0;
                                            ...
                                            if params.input_rotation != 0.0 {
                                                let rotation = params.input_rotation
                                                    * (std::f32::consts::PI / 180.0);
                                                let size = frame_size;
                                                frame_size = rotate_point(
                                                    size,
                                                    rotation,
                                                    (0.0, 0.0),
                                                    (0.0, 0.0),
                                                ...
                                                frame_size = (
                                                    frame_size.0.abs().round(),
                                                    frame_size.1.abs().round(),
                                                );
                                            }
                                            uv = Vector2::new(
                                                map_coord(
                                                    ...
                                                    frame_size.0,
                                                    params.source_rect[0] as f32,
                                                    (params.source_rect[0] + params.source_rect[2])
                                                        as f32,
                                                ),
                                                map_coord(
                                                    uv.y,
                                                    ...
                                                    frame_size.1,
                                                    params.source_rect[1] as f32,
                                                    (params.source_rect[1] + params.source_rect[3])
                                                        as f32,
                                                ),
                                            );
                                            pt2 = Vector2::new(
                                            ...
                                            let c1 = sample_input_at::<I, T>(
                                                uv, &jac, input, params, &bg, drawing,
                                            );
                                            let c2 = sample_input_at::<I, T>(
                                                pt2, &jac, input, params, &bg, drawing,
                                            ); // FIXME: jac should be adjusted for pt2
...
pub fn undistort_points_for_optical_flow(
    ...
    let (camera_matrix, distortion_coeffs, _, _, _, _, _) =
        FrameTransform::get_lens_data_at_timestamp(params, timestamp_us as f64 / 1000.0, false);
...
pub fn undistort_points(distorted: &[(f32, f32)], camera_matrix: Matrix3<f64>, distortion_coeffs: &[f64; 24], rotation: Matrix3<f64>, p: Option<Matrix3<f64>>, rot_per_point: Option<Vec<Matrix3<f64>>>, params: &ComputeParams, lens_correction_amount: f64, fov: f64, timestamp_ms: f64, shift_per_point: Option<Vec<(f32, f32, f32, f32, f32)>>, mesh: Option<Vec<f64>>, r_limit: f64) -> Vec<(f32, f32)> {
    ...
    let lens_correction = if lens_correction_amount < 1.0 {
        // Use the same output projection as the render, including NiYien's anamorphic stretch.
        let (out_c, out_f) = add_back_output_projection_from_kernel(&kernel_params);
        let out_c = (out_c.x, out_c.y);
        let out_f = (out_f.x, out_f.y);
        ...
        if let Some(ray) = ray {
            ...
            if let Some((out_c, amount, factor, out_f, n_max, radial)) = lens_correction {
                ...
                let r_of = |o: (f32, f32)| -> (f32, f32) {
                    let mut q = o;
                    if let Some(digital) = &params.digital_lens {
                        // Match the existing digital warp in all NiYien rendering backends.
                        if let Some(d) = digital.undistort_point(q, &kernel_params) {
                            q = d;
                        }
                    }
...
/// damping holds.
pub(crate) fn invert_lens_correction_blend(
    target: (f32, f32),
    out_c: (f32, f32),
    out_f: (f32, f32),
    n_max: f32,
    ...
    let mut o = if dlen > 1e-6 {
        ...
        let resid = |rho: f32| -> f32 {
            ...
            let r = r_of(o);
            (amount * o.0 + factor * r.0 - target.0) * u.0
                + (amount * o.1 + factor * r.1 - target.1) * u.1
        };
    ...
    let eval = |o: (f32, f32)| -> ((f32, f32), (f32, f32), f32) {
        let r = r_of(o);
        let g = (
            amount * o.0 + factor * r.0 - target.0,
            amount * o.1 + factor * r.1 - target.1,
        );
    ...
    for _ in 0..10 {
        ...
        let j11 = amount + factor * (rx.0 - r.0) / EPS;
        let j12 = factor * (ry.0 - r.0) / EPS;
        let j21 = factor * (rx.1 - r.1) / EPS;
        let j22 = amount + factor * (ry.1 - r.1) / EPS;
...
mod tests {
    ...
    fn stretch(s: (f32, f32)) -> impl Fn((f32, f32)) -> (f32, f32) {
        move |o| {
            (
                OUT_C.0 + s.0 * (o.0 - OUT_C.0),
                OUT_C.1 + s.1 * (o.1 - OUT_C.1),
            )
        }
    }
    ...
    fn closed_form(target: (f32, f32), s: (f32, f32), amount: f32) -> (f32, f32) {
        ...
        (
            OUT_C.0 + (target.0 - OUT_C.0) / (amount + factor * s.0),
            OUT_C.1 + (target.1 - OUT_C.1) / (amount + factor * s.1),
        )
    }
    fn residual(
        o: (f32, f32),
        target: (f32, f32),
        amount: f32,
        r_of: &dyn Fn((f32, f32)) -> (f32, f32),
    ) -> f32 {
        let r = r_of(o);
        let factor = 1.0 - amount;
        ((amount * o.0 + factor * r.0 - target.0).powi(2)
            + (amount * o.1 + factor * r.1 - target.1).powi(2))
        .sqrt()
    }
    ...
    fn identity_map_returns_the_target() {
        ...
        for radial in [true, false] {
            let o =
                invert_lens_correction_blend(target, OUT_C, OUT_F, N_MAX, 0.5, 0.5, radial, &r_of);
    ...
    fn nonradial_map_is_polished_against_the_original_target() {
        ...
        assert!(
            residual(ray, target, 0.5, &r_of) > 1.0,
            "the ray answer already solves the 2D equation, the map isn't anisotropic enough to test anything"
        );
    ...
    fn polish_never_worsens_the_ray_answer() {
        ...
        for &(dx, dy) in &[
            ...
            let ray =
                invert_lens_correction_blend(target, OUT_C, OUT_F, N_MAX, 0.3, 0.7, true, &r_of);
            let polished =
                invert_lens_correction_blend(target, OUT_C, OUT_F, N_MAX, 0.3, 0.7, false, &r_of);
            assert!(
                residual(polished, target, 0.3, &r_of) <= residual(ray, target, 0.3, &r_of) + 1e-3,
                "{target:?}"
            );
        }
    }
