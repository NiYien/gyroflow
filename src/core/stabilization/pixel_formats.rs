...
fn rgb_to_yuv(v: Vector4<f32>, is_limited: bool) -> Vector4<f32> {
    ...
    fn remap_to_limited(v: f32, is_y: bool) -> f32 {
        if is_y {
            (16.0 / 255.0) + (v * ((235.0 - 16.0) / 255.0))
        } else {
            (16.0 / 255.0) + (v * ((240.0 - 16.0) / 255.0))
        }
    }
    ...
    let mut ret = Vector4::new(
        ...
        ((-KR * US) * v[0] + (-KG * US) * v[1] + ((1.0 - KB) * US) * v[2] + 0.5)
            .max(0.0)
            .min(1.0),
        (((1.0 - KR) * VS) * v[0] + (-KG * VS) * v[1] + (-KB * VS) * v[2] + 0.5)
            .max(0.0)
            .min(1.0),
        v[3].max(0.0).min(1.0),
    );
...
pub struct Luma8(u8);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct Luma16(u16);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct RGB8(u8, u8, u8);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct RGBA8(u8, u8, u8, u8);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct BGRA8(u8, u8, u8, u8);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct RGB16(u16, u16, u16);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct RGBA16(u16, u16, u16, u16);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct AYUV16(u16, u16, u16, u16);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct RGBAf(f32, f32, f32, f32);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct RGBAf16(Ff16, Ff16, Ff16, Ff16);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct R32f(f32);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct UV8(u8, u8);
#[derive(Default, Clone, Copy, PartialEq, PartialOrd)]
pub struct UV16(u16, u16);
...
impl PixelType for Luma8 {
    ...
    #[inline]
    fn from_float_glam(v: stabilize_spirv::glam::Vec4) -> Self {
        Self(v[0] as Self::Scalar)
    }
    #[inline]
    fn to_float(v: Self) -> Vector4<f32> {
        Vector4::new(v.0 as f32, 0.0, 0.0, 0.0)
    }
    #[inline]
    fn from_float(v: Vector4<f32>) -> Self {
        Self(v[0] as Self::Scalar)
    ...
    #[inline]
    fn from_rgb_color(v: Vector4<f32>, ind: &[usize], is_limited: bool) -> Vector4<f32> {
        Vector4::new(rgb_to_yuv(v, is_limited)[ind[0]], 0.0, 0.0, 0.0)
    }
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("uchar", "convert_uchar_sat", "float", "convert_float")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::R8Unorm, "f32", true))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(255.0)
...
impl PixelType for Luma16 {
    ...
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("ushort", "convert_ushort_sat", "float", "convert_float")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::R16Uint, "u32", false))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(65535.0)
...
impl PixelType for RGB8 {
    ...
    #[inline]
    fn to_float(v: Self) -> Vector4<f32> {
        Vector4::new(v.0 as f32, v.1 as f32, v.2 as f32, 0.0)
    }
    #[inline]
    fn from_float(v: Vector4<f32>) -> Self {
        Self(
    ...
    #[inline]
    fn from_rgb_color(v: Vector4<f32>, _ind: &[usize], _is_limited: bool) -> Vector4<f32> {
        v
    }
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("uchar3", "convert_uchar3_sat", "float4", "convert_float4")
    } // FIXME: uchar3 can't be converted to float4
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        None
    }
...
impl PixelType for RGBA8 {
    ...
    #[inline]
    fn to_float(v: Self) -> Vector4<f32> {
        Vector4::new(v.0 as f32, v.1 as f32, v.2 as f32, v.3 as f32)
    }
    #[inline]
    fn from_float(v: Vector4<f32>) -> Self {
        Self(
    ...
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Rgba8Unorm, "f32", true))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(255.0)
...
impl PixelType for BGRA8 {
    ...
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Bgra8Unorm, "f32", true))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(255.0)
...
impl PixelType for RGB16 {
    ...
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("ushort3", "convert_ushort3_sat", "float4", "convert_float4")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        None
...
impl PixelType for RGBA16 {
    ...
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("ushort4", "convert_ushort4_sat", "float4", "convert_float4")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Rgba16Uint, "u32", false))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(65535.0)
...
impl PixelType for AYUV16 {
    ...
    #[inline]
    fn from_rgb_color(v: Vector4<f32>, ind: &[usize], is_limited: bool) -> Vector4<f32> {
        let yuv = rgb_to_yuv(v, is_limited);
        Vector4::new(yuv[ind[0]], yuv[ind[1]], yuv[ind[2]], yuv[ind[3]])
    }
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("ushort4", "convert_ushort4_sat", "float4", "convert_float4")
...
impl PixelType for RGBAf {
    ...
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("float4", "convert_float4", "float4", "convert_float4")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Rgba32Float, "f32", false))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        None
...
impl PixelType for RGBAf16 {
    ...
    fn from_float_glam(v: stabilize_spirv::glam::Vec4) -> Self {
        Self(
            Ff16(half::f16::from_f32(v[0])),
            Ff16(half::f16::from_f32(v[1])),
            Ff16(half::f16::from_f32(v[2])),
            Ff16(half::f16::from_f32(v[3])),
        )
    }
    #[inline]
    fn to_float(v: Self) -> Vector4<f32> {
    ...
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        (
            ...
            "convert_half4",
            "float4",
            "convert_half4_to_float4",
        )
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Rgba16Float, "f32", false))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        None
...
impl PixelType for R32f {
    ...
    #[inline]
    fn from_rgb_color(v: Vector4<f32>, ind: &[usize], _is_limited: bool) -> Vector4<f32> {
        Vector4::new(v[ind[0]], 0.0, 0.0, 0.0)
    }
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("float", "convert_float", "float", "convert_float")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::R32Float, "f32", false))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        None
...
impl PixelType for UV8 {
    ...
    #[inline]
    fn from_float_glam(v: stabilize_spirv::glam::Vec4) -> Self {
        Self(v[0] as Self::Scalar, v[1] as Self::Scalar)
    }
    #[inline]
    fn to_float(v: Self) -> Vector4<f32> {
        Vector4::new(v.0 as f32, v.1 as f32, 0.0, 0.0)
    }
    #[inline]
    fn from_float(v: Vector4<f32>) -> Self {
        Self(v[0] as Self::Scalar, v[1] as Self::Scalar)
    ...
    fn from_rgb_color(v: Vector4<f32>, ind: &[usize], is_limited: bool) -> Vector4<f32> {
        let yuv = rgb_to_yuv(v, is_limited);
        Vector4::new(yuv[ind[0]], yuv[ind[1]], 0.0, 0.0)
    }
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("uchar2", "convert_uchar2_sat", "float2", "convert_float2")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Rg8Unorm, "f32", true))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(255.0)
...
impl PixelType for UV16 {
    ...
    #[inline]
    fn ocl_names() -> (&'static str, &'static str, &'static str, &'static str) {
        ("ushort2", "convert_ushort2_sat", "float2", "convert_float2")
    }
    #[inline]
    fn wgpu_format() -> Option<(wgpu::TextureFormat, &'static str, bool)> {
        Some((wgpu::TextureFormat::Rg16Uint, "u32", false))
    }
    #[inline]
    fn default_max_value() -> Option<f32> {
        Some(65535.0)
