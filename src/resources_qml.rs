...
qrc!(pub rsrc_qml,
    "/" {
        ...
        "src/ui/menu/mounting_orientation.js",
        "resources/lens_presets/index.json",
        ...
        "src/ui/components/ZoomModeSelector.qml",
        ...
        "src/ui/components/FeedbackDialog.qml",
        "src/ui/components/FileDialog.qml",
        "src/ui/components/FolderSelectionContinuation.qml",
        ...
        "src/ui/components/SectionDivider.qml",
        ...
        "src/ui/components/TutorialOverlay.qml",
        "src/ui/components/TutorialQueueRow.qml",
        "src/ui/components/VideoSourcePicker.qml",
        "src/ui/components/IosQueueOutputPolicy.qml",
